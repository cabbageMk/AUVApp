 ...
 *
 */
data class VideoRelated(val itemList: List<Item>, val count: Int, val total: Int, val nextPageUrl: String?, val adExist: Boolean) {
 ...
 *
 */
data class VideoReplies(val itemList: List<Item>, val count: Int, val total: Int, val nextPageUrl: String?, val adExist: Boolean) {
